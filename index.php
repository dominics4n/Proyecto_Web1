            ...
            <div class="col s10 offset-s1">
                ...
                <div class="row" >
                    <div class="input-field">
                        ...
                        <input placeholder="Correo" name="correo_usuario" id="correo_usuario" type="email" class="white-text" required>
                ...
                <div class="row" >
                    <div class="input-field">
                        ...
                        name="vg_usuario" id="vg_usuario" type="text" class="white-text" required>
                ...
                <div class="row" >
                    <div class="input-field">
                        ...
                        <input placeholder="Aurora my beloved" name="music_usuario" id="music_usuario" type="text" class="white-text" required>
                ...
                <div class="row" >
                    <div class="input-field">
                        ...
                        name="quote_usuario" id="quote_usuario" type="text" class="white-text">
