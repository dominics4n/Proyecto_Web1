...
<div class="container">
<div class="row">
    <form action="escena05Sufrimiento.php" method="post" class="col s10 offset-s1">
    <div class="col s8 offset-s2">
        ...
        <div class="col s6 center-align">
            <p>
                <label>
                    <input type="radio" name="escena4" value="Vendedor" required />
                    <span class="white-text">Vendedor</span>
                </label>
            </p>
        </div>
        <div class="col s6 center-align">
...
<div class="container">
<div class="row">
    <form action="escena05Sombrita.php" method="post" class="col s10 offset-s1">
    <div class="col s8 offset-s2">
        <br>
        <div class="row bordestemporal formtemporal">
        <div class="col s6 center-align">
            <p>
                <label>
                    <input type="radio" name="escena4" value="Camino Largo" required />
                    <span class="white-text">Camino Largo</span>
                </label>
            </p>
        </div>
        <div class="col s6 center-align">
            <p>
            <label>
                <input type="radio" name="escena4" value="Atajo" />
                <span class="white-text">Atajo</span>
            </label>
            </p>
        </div>
        </div>
