...
<div class="row">
    ...
    <div class="col s8 offset-s2">
        ...
        <div class="col s6 center-align">
            <p>
                <label>
                    <input type="radio" name="escena5" value="Cocodrilo Legendario" required />
                    <span class="white-text">Cocodrilo Legendario</span>
                </label>
            </p>
        </div>
        <div class="col s6 center-align">
            <p>
            <label>
                <input type="radio" name="escena5" value="Puente" />
                <span class="white-text">Puente</span>
            </label>
            </p>
        </div>
        </div>
